...
function init () {
  ...
  gsap.to(color, { r: 0.5, b: 1, g: 0, a: 1, duration: 2, delay: 1, ease: 'power3.inOut', repeat: -1, yoyo: true })
  gsap.to(test, { a: 0.0, b: 0.0, duration: 2, delay: 1, ease: 'power3.inOut', repeat: -1, yoyo: true })
